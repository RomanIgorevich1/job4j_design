...
public class Menu {
    private Integer addPost = 1;
    private Integer addManyPost = 2;
    private Integer showAllPost = 3;
    private Integer deletePost = 4;
    private String select = "Выберите меню";
    private String count = "Выберите количество создаваемых постов";
    private String textOfPost = "Введите текст";
    private String exit = "Конец работы";
    private String menu = """
    ...
    private void start(CommentGenerator commentGenerator, Scanner scanner,
        ...
        while (run) {
            ...
            } else if (showAllPost == userChoice) {
